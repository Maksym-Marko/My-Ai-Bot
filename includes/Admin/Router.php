...
use LSOMABWPPGNext\Admin\Entities\AdminMenu;
use LSOMABWPPGNext\Admin\Utilities\Notices\PathNotice;
...
class Router
{
    ...
    public function add($controller): object
    {
        ...
        $path = LSOMAB_PLUGIN_ABS_PATH . "{$this->rootFolder}{$controller}.php";

...
class AdminMenu
{
    ...
    public function addMenuPage(): void
    {
        ...
        add_menu_page(
            sprintf(esc_html__('%s', 'my-ai-bot'), $this->properties['pageTitle']),
            sprintf(esc_html__('%s', 'my-ai-bot'), $this->properties['menuTitle']),
    ...
    public function addOptionLink(): void
    {
        ...
        $baseName = LSOMAB_PLUGIN_BASE_NAME;
    ...
    public function addLink($links): array
    {
        ...
        $settingsLink = '<a href="' . get_admin_url() . 'options-general.php?page=' . $this->properties['menuSlug'] . '">' . sprintf(esc_html__('%s', 'my-ai-bot'), $this->properties['menuTitle']) . '</a>';

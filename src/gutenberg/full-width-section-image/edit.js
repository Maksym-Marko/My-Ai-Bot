...
export default function edit({ attributes, setAttributes }) {
	...
	return [
		<InspectorControls key="mx-settings">
			...
			<PanelBody title={__('Side Image', 'my-ai-bot')} initialOpen={true}>
						...
						<div className='mx-media-button-wrapper'>

							{
								attributes?.sideImageUrl ?
									(<div className="lsomab-cover-image-wrapper">
										<img src={attributes.sideImageUrl} />
										<Button
											icon="trash"
											text={__('Remove', 'my-ai-bot')}
											isDestructive
											onClick={() => {
												setAttributes({
													sideImageUrl: null,
			...
			<PanelBody title={__('Background Image', 'my-ai-bot')} initialOpen={false}>
		...
		>
			...
			<div className="wp-block-lsomab-full-width-section-image--image-wrapper">

				<img src={attributes.sideImageUrl} data-side-image-id={attributes.sideImageId} alt="" className="mx-side-img" />

			</div>

			<div className="wp-block-lsomab-full-width-section-image--content-wrapper">
				<div className="wp-block-lsomab-full-width-section-image--text">
					<InnerBlocks />
				</div>
			</div>
